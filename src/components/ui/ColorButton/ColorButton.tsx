...
export const ColorButton = component$(
  ({ type = 'button', color, label, onClick$, width }: ColorButtonProps) => (
    <button
      class={clsx(
        'relative flex items-center justify-center rounded-2xl px-5 py-2.5 font-medium no-underline transition-colors md:text-lg lg:rounded-2xl lg:px-6 lg:py-3 lg:text-xl  border-2 ',
        color === 'green' &&
